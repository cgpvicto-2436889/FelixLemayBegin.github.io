...
--
-- Hôte : localhost
-- Généré le : mar. 22 avr. 2025 à 18:55
...
CREATE TABLE `contacts` (
  `nom` varchar(168) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `contacts` (`nom`, `sujet`, `courriel`, `message`) VALUES
('Filoupoupo', 'Le plus fort Top Laner', 'filoupoupo@gmail.com', 'Trop BG'),
('Filoupoupo', 'Le plus fort Top Laner', 'filoupoupo@gmail.com', 'Trop BG'),
('wertgfdtgf', 'lkjhg', 'filoupoupo@gmail.com', 'lkjuhytr'),
('gfdes', 'hgfd', 'filoupoupo@gmail.com', 'hgfd'),
('bgfds', 'gfd', 'filoupoupo@gmail.com', 'gfd'),
('hgfd', 'hgfd', 'filoupoupo@gmail.com', 'hgfds'),
('gfdfgtr', 'gsz', 'filoupoupo@gmail.com', 'rhx'),
('gfdfgtr', 'gsz', 'filoupoupo@gmail.com', 'rhx'),
('bvc', 'bv', 'filoupoupo@gmail.com', 'bhgvcx'),
('gfdfgtr', 'wevwevewv', 'filoupoupo@gmail.com', 'poijuhygtfrd');
...
INSERT INTO `equipes` (`id`, `nom`, `slogan`, `commentaire`, `dateajout`, `jeu_id`) VALUES
(1, 'Les Titans Sanglants', 'Le sang forge notre puissance, la victoire scelle notre légende.', NULL, '2025-02-27', 3),
(2, 'Les Lames de l’Ombre', 'Invisible dans la nuit, implacable dans le combat.', NULL, '2025-02-27', 1),
(3, 'La Légion Immortelle', 'Nous ne reculons jamais, nous ne tombons jamais.\r\n\r\n', NULL, '2025-02-27', 3),
(4, 'Les Protecteurs Stellaires', 'Brillons plus fort que les ténèbres, combattons pour l’espoir.', NULL, '2025-02-27', 4),
(5, 'Le Cercle des Assassins', 'Un coup, une cible, une mort certaine.', NULL, '2025-02-27', 4),
(6, 'Les Colosses Indomptables', 'Nous sommes l’acier, vous êtes la poussière.', NULL, '2025-02-27', 5),
(7, 'La Horde du Chaos', 'Le chaos est notre maître, la destruction notre plaisir.', NULL, '2025-02-27', 2),
(8, 'Les Voyageurs du Néant', 'Entre les mondes, entre les âmes, nous réécrivons le destin.', NULL, '2025-02-27', 2),
(9, 'Les Ombres Rebelles', 'Nous ne suivons aucune règle, sauf celle de la victoire.', NULL, '2025-02-27', 2),
(10, 'Les Architectes du Destin', 'Nous ne prédisons pas l’avenir, nous le façonnons.', NULL, '2025-02-27', 1),
(11, 'les batards divins', 'je chasse ou ils chassent', NULL, '2025-04-21', 5);
...
(51, 'Bégin', 'Félix', 'jheude', 'filoupoupo@gmail.com', NULL, NULL),
(52, 'online', 'albion', 'albion_slm', 'albion@gmail.com', NULL, NULL),
(53, '', '', '', '', NULL, NULL);
...
(1, 'index.php', 'Tableau de bord', 'La page d\'acceuil du lanparty qui contient les cartes d\'équipes', 'Tableau de bord', 'Le lan party que vous ne voulez pas manquer', 1, '<div class=\"logo\"><img src=\"medias/commun/logoLanParty.png\"></div>', '2025-04-15 18:19:21'),
(2, 'resultats.php', 'Résultats', 'Consultez les résultats et statistiques des événements LAN Party.', 'Résultats', 'Visualisez les résultats de vos compétitions préférées.', 1, '<div class=\"logo\"><img src=\"medias/commun/logoLanParty.png\"></div>', '2025-04-15 10:00:00'),
(3, 'a-propos.php', 'À propos', 'Découvrez les objectifs de l\'étudiante derrière ce site, sa passion pour le web et son envie d\'apprendre.', 'À propos', 'Apprendre, progresser et devenir une pro du développement web !', 1, 'Mes objectifs pour cette page sont de la rendre belle et cool. Je veut avoir 100% et apprendre pleins de nouvelles choses pour devenir meilleure en developpement web<br><img src=\"medias/commun/moi%20ma%20face.jpg\" alt=\"photo de moi\">', '2025-04-15 10:30:00'),
(4, 'formulaire-contact.php', 'Formulaire de contact', 'Contactez-nous facilement à l\'aide de ce formulaire. Nous vous répondrons rapidement !\r\n', 'Formulaire', 'Une question ? Une suggestion ? Écrivez-nous !\r\n', 1, '<div class=\"logo\"><img src=\"medias/commun/logoLanParty.png\"></div>\r\n', '2025-04-15 10:50:00'),
(5, 'joueurs.php', 'La liste des joueurs', 'Fait la liste de tous les joueurs', 'Liste joueurs', 'vive la pleine lune des joueurs', 1, 'PErmet de voir tous les joueurs', '2025-04-17 20:10:09'),
(6, 'formulaire-joueurs.php', 'Ajout de joueur', 'Permet d\'ajouter des joueurs dans le lan party', 'AJout joueur', 'Ajoute ton joueurs, afin de mieux gagner youpi !!', 1, 'Ajoute un purer de joueur', '2025-04-17 20:19:29'),
(7, 'formulaire-equipe.php', 'Ajout d\'équipe', 'Permet d\'Ajouter une équipe', 'Ajout équipe', 'Ajoute ton équipe, afin de pouvoir gagner pleins de choses :)', 1, 'Hey. Écoute fait juste écouter. Ajoute juste une équipe ok ?\r\n', '2025-04-09 22:37:17'),
(8, 'formulaire-resultat.php', 'Ajout d\'un résultat', 'Permet d\'Ajouter un résultat', 'Ajout de résultat', 'ajoute un resultat ou je t\'ajoute', 1, 'cool', '2025-04-16 14:45:04');
...
(6, 3, 3, 7, '2025-04-29 00:00:00'),
(7, 7, 7, 7, '2025-04-07 00:00:00'),
(8, 5, 6, 6, '2025-04-07 00:00:00'),
(9, 1, 1, 70, '2025-04-01 00:00:00');
...
--
ALTER TABLE `equipes`
  ADD CONSTRAINT `jeu_existant` FOREIGN KEY (`jeu_id`) REFERENCES `jeux` (`id`) ON DELETE SET NULL;
